...
public class DiscountTest {
    ...
    void testDdayDiscount() {
        Orders order = new Orders(10000, 5, false, 0, 0, 2000, 0);
    ...
    void testWeekdayDiscount() {
        Orders order = new Orders(10000, 5, false, 1000, 0, 0, 0);
    ...
    void testWeekendDiscount() {
        Orders order = new Orders(10000, 5, false, 0, 1500, 0, 0);
    ...
    void testSpecialDiscount() {
        Orders order = new Orders(10000, 5, false, 0, 0, 0, 1000);
    ...
    void testGiftedItem() {
        Orders order = new Orders(120000, 5, false, 0, 0, 0, 0);
